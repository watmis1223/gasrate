...
namespace CalculationOilPrice.Library.Entity.Setting.PriceCalculation.Models
{
    ...
    public class GeneralPriceScale
    {
        ...
        public decimal MinProfit
        {
            ...
            set { _MinProfit = Math.Round(value, 4); }
        }
        ...
        public decimal MaxProfit
        {
            ...
            set { _MaxProfit = Math.Round(value, 4); }
        }
    }
    public class GeneralConvert
    {
        ...
        public decimal EEUnitNumber
        {
            ...
            set { _EEUnitNumber = Math.Round(value, 4); }
        }
        ...
        public decimal VEUnitNumber
        {
            ...
            set { _VEUnitNumber = Math.Round(value, 4); }
        }
        ...
        public decimal UnitNumber
        {
            ...
            set { _UnitNumber = Math.Round(value, 4); }
        }
    }
    ...
    public class CalculationItemModel
    {
        ...
        public decimal AmountPercent
        {
            ...
            set { _AmountPercent = Math.Round(value, 4); }
        }
        ...
        public decimal AmountFix
        {
            ...
            set { _AmountFix = Math.Round(value, 4); }
        }
        ...
        public decimal VariableTotal
        {
            ...
            set { _VariableTotal = Math.Round(value, 4); }
        }
    ...
    public class ConvertModel
    {
        ...
        public decimal OriginalAmount
        {
            ...
            set { _OriginalAmount = Math.Round(value, 4); }
        }
    ...
    public class CalculationNoteModel
    {
        ...
        public decimal Quantity
        {
            ...
            set { _Quantity = Math.Round(value, 4); }
        }
    }
    #endregion
}
